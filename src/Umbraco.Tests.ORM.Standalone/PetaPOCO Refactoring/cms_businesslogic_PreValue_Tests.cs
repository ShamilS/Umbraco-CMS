...
//using umbraco.cms.businesslogic.datatype.PreValue;
...
namespace Umbraco.Tests.ORM
{
    ...
    public class cms_businesslogic_PreValue_Tests : BaseORMTest
    {
        ...
        private void assertPreValueSetup(PreValue testPreValue, PreValueDto savedPreValue)
        {
        ...
        public void Test_PreValue_MakeNew()
        {
            ...
            var savedPrevalue = TRAL.GetDto<PreValueDto>(newPreValue.Id);
        ...
        public void Test_PreValue_Delete(int testCase)
        {
            switch (testCase)
            {
                ...
                case 2:
                    {
                        var savedPrevalue1 = TRAL.GetDto<PreValueDto>(_preValue.Id);
                        ...
                        var savedPrevalue2 = TRAL.GetDto<PreValueDto>(_preValue.Id);
        ...
        public void Test_PreValue_Save()
        {
            ...
            var savedNewPreValue = TRAL.GetDto<PreValueDto>(newPreValue.Id);
